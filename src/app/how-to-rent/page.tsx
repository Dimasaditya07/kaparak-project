...
const steps = [
  {
    ...
    desc: "Jelajahi katalog KAPARAK dan pilih peralatan atau paket yang sesuai dengan kebutuhan dan durasi petualanganmu.",
    icon: (
      <svg
...

  {
    ...
    desc: "Pilih jumlah peralatan atau paket yang ingin disewa, kemudian tambahkan ke keranjang untuk melanjutkan proses penyewaan.",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="none"
...

  {
    ...
    desc: "Periksa kembali peralatan yang dipilih, kemudian lakukan checkout dan tentukan tanggal pengambilan serta tanggal pengembalian.",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="none"
...

  {
    id: "04",
    title: "Pembayaran DP",
    desc: "Lakukan pembayaran DP melalui sistem pembayaran KAPARAK. Setelah pembayaran berhasil, status reservasi akan diperbarui dan dikonfirmasi.",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="none"
      ...
      >
        <path
          strokeLinecap="round"
          strokeLinejoin="round"
          d="M2.25 8.25h19.5m-16.5 0V6A2.25 2.25 0 0 1 7.5 3.75h9A2.25 2.25 0 0 1 18.75 6v2.25m-15 0v9.75A2.25 2.25 0 0 0 6 20.25h12a2.25 2.25 0 0 0 2.25-2.25V8.25m-15 0h15M6.75 12h3"
        />
      </svg>
    ),
  },
  ...
  {
    id: "05",
    title: "Ambil Peralatan",
    desc: "Datang pada tanggal pengambilan yang telah ditentukan. Admin akan memeriksa kondisi peralatan sebelum barang diserahkan kepada customer.",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="none"
      ...
      >
        <path
          strokeLinecap="round"
          strokeLinejoin="round"
          d="m21 7.5-9-5.25L3 7.5m18 0-9 5.25M21 7.5v9L12 21m0-8.25L3 7.5m9 5.25v9M3 7.5v9l9 5.25"
        />
      </svg>
    ),
  },

  {
    ...
    desc: "Kembalikan seluruh peralatan sesuai tanggal yang telah ditentukan. Admin akan memeriksa kondisi barang dan menyelesaikan proses penyewaan.",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="none"
...
const rules = [
  ...
  },
  {
    ...
    desc: "Keterlambatan pengembalian akan dikenakan denda sesuai dengan ketentuan yang berlaku pada sistem KAPARAK.",
  },
  {
    title: "Kerusakan & Kehilangan",
    desc: "Kerusakan atau kehilangan peralatan selama masa sewa menjadi tanggung jawab penyewa sesuai dengan ketentuan yang berlaku.",
  },
];
...
export default function HowToRent() {
  ...
  return (
    <main className="relative min-h-screen w-full bg-black text-white font-sans selection:bg-green-500 selection:text-white pt-32 pb-24 overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-[60vh] bg-linear-to-b from-green-900/10 to-black z-0 pointer-events-none" />

      <div className="absolute top-[20%] right-[-10%] w-[500px] h-[500px] bg-green-900/10 blur-[150px] rounded-full z-0 pointer-events-none" />

      <div className="absolute bottom-[-10%] left-[-10%] w-[600px] h-[600px] bg-green-950/20 blur-[150px] rounded-full z-0 pointer-events-none" />
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 md:px-10">
        ...
        >
          ...
          <div className="w-16 h-0.5 bg-green-500 mx-auto mt-8" />
        </motion.div>
              ...
              return (
                ...
                >
                  ...
                  <div className="w-full md:w-1/2 pl-16 md:pl-0">
                    <div
                      className={`bg-white/5 backdrop-blur-md border border-white/10 p-8 rounded-3xl hover:border-green-500/30 transition-colors duration-500 ${
        ...
        >
          {/* DECORATION */}
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-3/4 h-px bg-linear-to-r from-transparent via-green-500 to-transparent opacity-50" />
